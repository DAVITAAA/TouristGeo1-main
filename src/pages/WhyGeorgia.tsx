        ...
        <div className="container mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="lg:w-1/2 space-y-8 z-10">
              ...
              >
                <button className="px-8 py-4 bg-primary text-white rounded-full font-bold text-[15px] shadow-lg shadow-primary/20 hover:shadow-xl hover:-translate-y-1 active:translate-y-0 active:scale-95 transition-all flex items-center gap-2">
                  <span className="material-symbols-outlined text-[20px]">explore</span>
                  {t.wg_start_planning}
                </button>
                <button className="px-8 py-4 bg-white text-text-main rounded-full font-bold text-[15px] shadow-sm border border-border-light hover:bg-gray-50 active:scale-95 transition-all flex items-center gap-2">
            ...
            <div className="lg:w-1/2 relative">
              <motion.div 
                ...
                className="relative z-10 rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white aspect-[4/5] max-w-md mx-auto"
              >
                <img 
                ...
                <motion.div 
                  ...
                  className="absolute bottom-6 left-6 right-6 bg-white/10 backdrop-blur-md p-5 rounded-[2rem] flex items-center justify-between text-white border border-white/20 shadow-lg"
                >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {icons.map((item, i) => (
              <Reveal key={i} delay={i * 0.1}>
                <div className="bg-white p-6 rounded-[2rem] border border-border-light shadow-sm flex flex-col items-start gap-4 hover:shadow-md hover:border-gray-300 transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {destinations.map((dest, i) => (
              <Reveal key={i} delay={i * 0.1} variant="scale">
                  <div className="group relative h-[320px] sm:h-[420px] rounded-[2rem] overflow-hidden shadow-md">
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
            <div className="lg:w-1/2 space-y-8">
              ...
              <Reveal delay={0.1}>
                  <div className="relative aspect-video rounded-[2rem] overflow-hidden bg-[#0f172a] shadow-xl group border border-border-light">
                    <img 
            ...
            <div className="lg:w-1/2 space-y-10">
              <Reveal delay={0.2}>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={i} className="flex items-center gap-5 p-5 rounded-[2rem] bg-gray-50 border border-border-light hover:border-gray-300 hover:bg-white transition-all">
              ...
              <Reveal delay={0.3}>
                  <div className="p-8 rounded-[2rem] bg-secondary text-white space-y-5 relative overflow-hidden shadow-lg shadow-secondary/20">
                    <div className="relative z-10 space-y-3">
                      ...
                      <button className="w-full sm:w-auto px-8 py-3.5 mt-2 bg-primary text-white rounded-full font-bold text-[14px] flex items-center justify-center gap-2 shadow-lg hover:shadow-xl hover:bg-primary/95 active:scale-95 transition-all">
